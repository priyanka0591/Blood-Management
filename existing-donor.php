...
<body>
    ...
    <img class="bg" src="img/blood-hand.jpg" alt="Not available">
    <nav class="navbar navbar-expand-lg navbar-success" style="background-color: white;">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown" style="margin-left: 15%; padding:0%">
            <ul class="navbar-nav" style="margin-left:35%;">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="user-home.php">User Account</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="admin-home.php">Admin Account</a>
                </li>
    ...
    <form action="" method="post">
        <div class="transbox">
            <div class="container-xxl">
                ...
                <div class="button">
                    <input type="submit" name="sub" value="Collect">
                </div>
